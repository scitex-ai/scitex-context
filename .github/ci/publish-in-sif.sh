...
# (project=scitex-context, owner=ywatanabe1989, repo=scitex-context,
...
TMPDIR="/tmp/publish-scitex_context-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-context dist/* uploaded to PyPI via manual OIDC trusted publishing"
